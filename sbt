...
INTERNAL_OPTS="-Dfile.encoding=UTF-8 -Xss8M -Xmx1G -d64 -noverify -XX:+CMSClassUnloadingEnabled -XX:+UseConcMarkSweepGC -XX:MaxPermSize=512M -XX:ReservedCodeCacheSize=128M"
